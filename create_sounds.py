...
df_words = pd.read_excel('stimuli/words_de.xlsx', index_col=0)

os.makedirs('stimuli/sounds/', exist_ok=True)
...
df_words.to_excel('stimuli/words_de.xlsx')
