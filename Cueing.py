    ...
    def play_sound_b():
        ...
        while True:
            ...
            while stop_sound_b.is_set() and index < len(sound_b_list):
                ...
                trigger_val = index
                send_trigger (trigger_val, duration = 0.005)
                time.sleep (0.01)
                trigger_cat = (int(sounds_data.loc[index, "cat"])-1)*50 + index
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    if stop_sound_b.is_set():
                        ...
                        send_trigger (251, duration = 0.005)
                    else:
                    ...
                    sound_a_volume = min(2.0, sound_a_volume + 0.1)
                    sound_a.set_volume(sound_a_volume)
                    ...
                    sound_b_volume = min(2.0, sound_b_volume + 0.1)
